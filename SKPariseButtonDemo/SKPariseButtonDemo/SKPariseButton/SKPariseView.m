...
- (void)initSubviews {
    ...
    skLabel = [[UILabel alloc] init];
    skLabel.translatesAutoresizingMaskIntoConstraints = NO;
    skLabel.textAlignment = NSTextAlignmentCenter;
    skLabel.text = @"0";
    [self addSubview:skLabel];
    [self constraintItem:skLabel toItem:self topMultiplier:0 topConstant:0 bottomMultiplier:0 bottomConstant:0 leftMultiplier:0 leftConstant:0 rightMultiplier:1 rightConstant:-10 widthMultiplier:0 width:0 heightMultiplier:0 height:20];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:skLabel attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeCenterY multiplier:1 constant:0]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:skLabel attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:skImageView attribute:NSLayoutAttributeRight multiplier:1 constant:5]];
}
